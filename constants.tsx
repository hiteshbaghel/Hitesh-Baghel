...
const CppIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 128 128" {...props}>
        <path fill="#00599C" d="M49.2,25.8C22.2,25.8,0,48,0,75s22.2,49.2,49.2,49.2s49.2-22.2,49.2-49.2S76.2,25.8,49.2,25.8z M49.2,115.8 c-22.5,0-40.8-18.3-40.8-40.8S26.7,34.2,49.2,34.2s40.8,18.3,40.8,40.8S71.7,115.8,49.2,115.8z"/>
        <path fill="#00599C" d="M110.8,2.2c-5.7,0-10.2,4.6-10.2,10.2c0,5.7,4.6,10.2,10.2,10.2c5.7,0,10.2-4.6,10.2-10.2S116.5,2.2,110.8,2.2z M110.8,14.2c-0.9,0-1.8-0.7-1.8-1.8s0.7-1.8,1.8-1.8s1.8,0.7,1.8,1.8S111.7,14.2,110.8,14.2z"/>
        <path fill="#659AD2" d="M49.2,34.2c-22.5,0-40.8,18.3-40.8,40.8S26.7,115.8,49.2,115.8s40.8-18.3,40.8-40.8S71.7,34.2,49.2,34.2z"/>
        <path fill="#FFFFFF" d="M51.8,76.5h-5v5h-4.2v-5h-5v-4.2h5v-5h4.2v5h5V76.5z M66.8,76.5h-5v5h-4.2v-5h-5v-4.2h5v-5h4.2v5h5V76.5z M54.2,60.2 c-11.1,0-20,9-20,20s9,20,20,20s20-9,20-20S65.2,60.2,54.2,60.2z M54.2,91.8c-6.2,0-11.2-5-11.2-11.2s5-11.2,11.2-11.2 s11.2,5,11.2,11.2S60.3,91.8,54.2,91.8z"/>
    </svg>
);
const HibernateIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 128 128" {...props}>
        <path fill="#ACACAC" d="M115.2,69.5c-4-4.8-10.4-12-16.8-16.8c-2.4-1.6-4.8-2.4-8-3.2c-2.4-0.8-5.6-0.8-8-0.8c-2.4,0-5.6,0.8-8,1.6 c-2.4,0.8-5.6,2.4-8.8,4c-5.6,3.2-11.2,8.8-16,14.4c-0.8,0.8-1.6,1.6-2.4,2.4c-4,4-8,8-10.4,12.8c-2.4,4-4,8-4,11.2 c0,3.2,0,5.6,0.8,7.2c0.8,1.6,1.6,3.2,3.2,4c0.8,0.8,2.4,1.6,4,2.4c1.6,0.8,3.2,0.8,4.8,0.8c5.6,0,10.4-4,15.2-9.6 c0.8-0.8,1.6-1.6,2.4-2.4c4.8-5.6,10.4-10.4,16.8-13.6c2.4-1.6,4.8-2.4,7.2-3.2c1.6-0.8,3.2-0.8,4.8-0.8c1.6,0,3.2,0,4.8,0.8 c2.4,0.8,4.8,1.6,7.2,3.2c6.4,3.2,12,8,16.8,13.6c0.8,0.8,1.6,1.6,2.4,2.4c4.8,5.6,9.6,9.6,15.2,9.6c1.6,0,3.2,0,4.8-0.8 c1.6-0.8,3.2-1.6,4-2.4c1.6-1.6,2.4-3.2,3.2-4c0.8-1.6,0.8-4,0.8-7.2C119.2,77.5,117.6,73.5,115.2,69.5z"/>
        <path fill="#59666C" d="M83.2,19.9c2.4-2.4,4.8-4,8-6.4c1.6-1.6,3.2-3.2,4-4.8c1.6-1.6,2.4-4,2.4-6.4c0-1.6,0-3.2-0.8-4 c-0.8-0.8-1.6-1.6-3.2-1.6c-1.6,0-3.2,0.8-4.8,2.4c-1.6,1.6-3.2,4-4.8,6.4c-1.6,2.4-3.2,4.8-5.6,7.2c-2.4,2.4-4.8,4.8-7.2,6.4 c-2.4,2.4-4,4-6.4,5.6c-4.8,3.2-8.8,5.6-12.8,7.2c-4,1.6-8,2.4-11.2,2.4c-4,0-7.2-0.8-10.4-2.4c-3.2-1.6-5.6-4-8-6.4 c-1.6-1.6-2.4-3.2-3.2-4.8c-0.8-1.6-0.8-3.2-0.8-4.8c0-3.2,0.8-5.6,3.2-8c0.8-0.8,2.4-1.6,4-2.4c1.6-0.8,3.2-0.8,4.8-0.8 c3.2,0,6.4,0.8,8.8,2.4c2.4,1.6,4.8,4,7.2,6.4c1.6,1.6,3.2,3.2,4.8,4c1.6,1.6,3.2,2.4,5.6,3.2c2.4,0.8,4.8,0.8,6.4,0.8 c2.4,0,4.8-0.8,7.2-1.6C76,26.3,80,23.1,83.2,19.9z"/>
    </svg>
);
